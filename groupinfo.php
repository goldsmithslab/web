<?php
    ...
    $page = new Page('Group Information');
    $page->head();
    ?>
...
<div class="campl-listing-item event-listing clearfix">
    ...
    <div class="campl-column5">
        <div class="campl-content-container campl-listing-txt">
            <p class="campl-listing-title"><a href="http://www.msm.cam.ac.uk/department/profiles/burstein.php">Professor Tim Burstein</a></p>
...
<div class="campl-listing-item event-listing clearfix">
    ...
    <div class="campl-column5">
        <div class="campl-content-container campl-listing-txt">
            <p class="campl-listing-title"><a href="kf283.php">Kieran Fahy</a></p>
    ...
    <div class="campl-column5">
        <div class="campl-content-container campl-listing-txt">
            <p class="campl-listing-title"><a href="ep320.php">Emma Pewsey</a></p>
    ...
    <div class="campl-column5">
        <div class="campl-content-container campl-listing-txt">
            <p class="campl-listing-title"><a href="am2018.php">Abdulaziz Moshaweh</a></p>
    ...
    <div class="campl-column5">
        <div class="campl-content-container campl-listing-txt">
            <p class="campl-listing-title"><a href="vc273.php">Varun Choda</a></p>
    ...
    <div class="campl-column5">
        <div class="campl-content-container campl-listing-txt">
            <p class="campl-listing-title"><a href="sna27.php">Siti Ahmad-Nor</a></p>
        ...
        <div class="campl-listing-item event-listing clearfix">
            ...
            <div class="campl-column5">
                <div class="campl-content-container campl-listing-txt">
                    <p class="campl-listing-title"><a href="http://www.kth.se/en/che/divisions/surfcorr/personal/gunilla-herting-phd-1.22290">Gunilla Herting</a></p>
    ...
    <div class="campl-listing-item event-listing clearfix">
        ...
        <div class="campl-column5">
            <div class="campl-content-container campl-listing-txt">
                <p class="campl-listing-title">Ben Daymond</p>

            </div>
        </div>
        <div class="campl-column7">
            <div class="campl-content-container campl-listing-img" >
                <img src="images/xyc21.jpg" alt="Yao Chin" class="campl-scale-with-grid" />
            </div>

        </div>
        <div class="campl-column5">
            <div class="campl-content-container campl-listing-txt">
                <p class="campl-listing-title">Yao Chin</p>
