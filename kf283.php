 ...
 * Anything with a star in - replace with your information.
 */

include 'common.inc.php';
$page = new Page('Kieran Fahy');
$page->head();
        ...
        <div class="campl-listing-item profile-listing clearfix">
            <div class="campl-column9">
                <div class="campl-content-container campl-listing-txt">
                    ...
                    <p class="campl-break-word">Telephone: +44 (0)1223(3)34371 <br />
                        Email: <a href="mailto:kf283@cam.ac.uk">kf283@cam.ac.uk</a> <br />
            ...
            <div class="campl-column3">
                <div class="campl-content-container campl-listing-img">
                    <img alt="Kieran Fahy"  src="images/kf283.jpg" class="campl-scale-with-grid" />
                </div>
            </div>
        </div>
